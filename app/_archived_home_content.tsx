...
export function ArchivedHomeContent() {
  ...
  return (
    <div className="page-shell">
      <Header />
      <main>
        <section className="section section-band-warm reveal" id="product">
          <div className="container">
            <div className="section-head wide">
              <h2>
                ...
                <span>
                  {" "}
                  AutoDSM gives teams a precise system to build from instead of a stale approximation.
                </span>
              </h2>
              <p className="product-definition">
                ...
                (components, design tokens, typography, and assets), and opens{" "}
                <strong>pull requests</strong> when it detects design-system drift—so agents and developers
                build against the real system, not a stale handoff.
              </p>
          ...
          <div className="container">
            <div className="section-head section-head--wide-titles">
              <h2>
                ...
                <span>
                  {" "}
                  No stories to author. No config files to maintain. AutoDSM reads the code and handles the
                  rest.
                </span>
              </h2>
            </div>
          ...
          <div className="container">
            <div className="section-head section-head--wide-titles">
              <h2>
                ...
                <span>
                  Live components, real tokens, and context for your agents—always tied to the repo.
                </span>
              </h2>
            </div>
        ...
        <section className="section section-band-warm reveal" id="faq">
          <div className="container">
            <div className="section-head section-head--wide-titles">
              <h2>
                Common questions.
                <span>
                  How it differs from Storybook, how it pairs with AI tools, and what “fix” really means.
                </span>
              </h2>
            </div>
        ...
        <section className="section section-final-cta reveal" id="final-cta">
          <div className="container">
            <div className="final-cta-panel">
              <div className="final-cta-inner">
                <div className="section-head">
                  <h2>
                    Stop maintaining your design system by hand.
                    <span> Join the waitlist and ship a living brand book tied to your repo.</span>
                  </h2>
                </div>
                <p>
                  AutoDSM gives you a single living brand book, agent-ready context, and pull requests when
                  drift shows up.
                </p>
